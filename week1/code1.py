...
img_gray = cv2.imread('E:\\test_img\\jpeg\\original\\img1.jpg', 0)
...
import cv2
img = cv2.imread('E:\\test_img\\jpeg\\original\\img1.jpg')
cv2.imshow('lena', img)
key = cv2.waitKey()
if key == 27:
    cv2.destroyAllWindows()
...
###############################
# gamma correction
img_dark = cv2.imread('E:\\test_img\\jpeg\\original\\img1.jpg')
cv2.imshow('lena', img_dark)
key = cv2.waitKey()
if key == 27:
    cv2.destroyAllWindows()
